-- 0001_update_functions_and_procs.sql
-- Creates 2 functions and updates 2 stored procedures.
...
*******************************************************************************************************************************/
DROP FUNCTION IF EXISTS dbo.Decendant_C;
DELIMITER $$
...
SELECT '0001_update_functions_and_procs.sql', NULL, 'Create 2 functions and update 2 sprocs'
WHERE NOT EXISTS (
    SELECT 1
      FROM db_migrations
     WHERE script_name = '0001_update_functions_and_procs.sql'
);
